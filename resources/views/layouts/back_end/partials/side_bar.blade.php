    ...
    <div class="scrollbar-sidebar">
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li>
                    <a href="#">
                        <i class="fa-solid fa-car metismenu-icon"></i>
                        Components
                        <i class="fa-solid fa-angle-down metismenu-state-icon caret-left"></i>
                    </a>
                    <ul>
                ...
                <li>
                    <a href="tables-regular.html">
                        <i class="fa-solid fa-table-list metismenu-icon"></i>
                        {{-- <i class=""></i> --}}
                        Tables
                    </a>
                </li>
                ...
                <li>
                    <a href="dashboard-boxes.html">
                        <i class="fa-solid fa-box-open metismenu-icon"></i>
                        Dashboard Boxes
                    </a>
                </li>
                ...
                <li>
                    <a href="forms-controls.html">
                        <i class="metismenu-icon fa-solid fa-computer-mouse"> </i>
                        <i class=""></i>
                        Forms Controls
                    </a>
                </li>
                <li>
                    <a href="forms-layouts.html">
                        <i class="metismenu-icon fa-solid fa-eye-dropper"> </i>
                        Forms
                        Layouts
                    </a>
                </li>
                <li>
                    <a href="forms-validation.html">
                        <i class="metismenu-icon fa-solid fa-check"> </i>
                        Forms
                        Validation
                    </a>
                </li>
