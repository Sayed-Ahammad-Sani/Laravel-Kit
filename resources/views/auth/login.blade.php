                ...
                <div class="hidden w-full xl:block xl:w-1/2">
                    <div class="px-26 py-17.5 text-center">
                        <a class="mb-5.5 inline-block" href="index.html">
                            <img class="hidden dark:block" width="150px"
                                src="{{asset('src/images/logo/ahammad-it-logo.png')}}" alt="Logo" />
                            <img class="dark:hidden" width="150px"
                                src="{{asset('src/images/logo/ahammad-it-logo.png')}}" alt="Logo" />
                        </a>

                        <p class="font-medium 2xl:px-20">
                            Laravel Kit. Developed by <a href="https://ahammadit.com" target="_blank">Ahammad IT</a>.
                        </p>
