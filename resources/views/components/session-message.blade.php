<div class="mb-2">
        ...
        <!-- Alerts Item -->
        <div id="alertBox"
                class="flex w-full border-l-6 border-warning bg-warning bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9 relative">
                <button id="closeAlert"
                        class="absolute top-2 right-2 inline-flex items-center justify-center gap-1.5 rounded-full px-5 py-2 text-center font-medium text-white hover:bg-opacity-90 lg:px-4 xl:px-5">
                        <span>
                                <svg class="fill-current" width="20" height="20" enable-background="new 0 0 512 512"
                                        viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg"
                                        xml:space="preserve" x="0" y="0" version="1.1">
        ...
        <!-- Alerts Item -->
        <div id="alertBox"
                class="flex w-full border-l-6 border-[#34D399] bg-[#34D399] bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9 relative">
                <button id="closeAlert"
                        class="absolute top-2 right-2 inline-flex items-center justify-center gap-1.5 rounded-full px-5 py-2 text-center font-medium text-white hover:bg-opacity-90 lg:px-4 xl:px-5">
                        <span>
                                <svg class="fill-current" width="20" height="20" enable-background="new 0 0 512 512"
        ...
        <!-- Alerts Item -->
        <div id="alertBox"
                class="flex w-full border-l-6 border-[#F87171] bg-[#F87171] bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9 relative">
                <button id="closeAlert"
                        class="absolute top-2 right-2 inline-flex items-center justify-center gap-1.5 rounded-full px-5 py-2 text-center font-medium text-white hover:bg-opacity-90 lg:px-4 xl:px-5">
                        <span>
                                <svg class="fill-current" width="20" height="20" enable-background="new 0 0 512 512"
